 ...
 */
export function replay(plugin_id: string, config: Uint8Array, seed: Uint8Array, moves: Uint8Array[], assets: Uint8Array): Uint8Array;
 ...
 */
export function setup(plugin_id: string, config: Uint8Array, seed: Uint8Array, assets: Uint8Array): Uint8Array;

/* @ts-self-types="./tabla_letras.d.ts" */
 ...
 * @returns {Uint8Array}
 */
export function replay(plugin_id, config, seed, moves, assets) {
    const ptr0 = passStringToWasm0(plugin_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function setup(plugin_id, config, seed, assets) {
    const ptr0 = passStringToWasm0(plugin_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(config, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;

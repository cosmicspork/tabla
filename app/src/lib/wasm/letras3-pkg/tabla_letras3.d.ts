...
export function apply_move(plugin_id: string, state: Uint8Array, mv: Uint8Array, assets: Uint8Array): Uint8Array;
 ...
 */
export function replay(plugin_id: string, config: Uint8Array, _private: Uint8Array, moves: Uint8Array[], assets: Uint8Array): Uint8Array;
 ...
 */
export function setup(plugin_id: string, config: Uint8Array, _private: Uint8Array, assets: Uint8Array): Uint8Array;

export function validate_move(plugin_id: string, state: Uint8Array, mv: Uint8Array, player: number, assets: Uint8Array): void;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
    readonly memory: WebAssembly.Memory;
    readonly apply_move: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number, number];
    readonly available_plugins: () => [number, number];
    readonly deck: (a: number, b: number) => [number, number, number, number];
    readonly decodeMove: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly encodeMove: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly is_game_over: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly player_view: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
    readonly plugin_version: (a: number, b: number) => [number, number, number];
    readonly replay: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => [number, number, number, number];
    readonly setup: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number, number];
    readonly validate_move: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number];
